        ...
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="col text-center text-md-left">
                        <h4 class="heading heading-xs strong-600 text-uppercase mb-2">
                            {{ translate('How To Buy?') }}
                        </h4>
                        <p>Choose your preferred payment method and enjoy shopping at arafashion.</p>
                        <div style="margin-left: 1px; height: 53px; width:191px;" class="display-td" >
                            <img style="height: 51px; width:191px;" src="{{ static_asset('frontend/images/icons/cards/newfoot.png')}}">
                        </div>
