<div class="header bg-white">
    <!-- Top Bar -->
    <div class="top-navbar" style="background:#9B5179; ">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col">
                    <ul class="inline-links d-lg-inline-block d-flex justify-content-between" style="color: white">
                        <ul class="inline-links">
                            <li>
                                <a href="#" class="top-bar-item">{{ translate('01711000000')}}</a>
                            </li>

                            <li>
                                <a href="#" class="top-bar-item">{{ translate(' contact@arafashioninc.com ')}}</a>
                            </li>
